...
LIB_API char *detection_to_json(detection *dets, int nboxes, int classes, char **names, long long int frame_id, char *filename, float im_width, float im_height); /// RW 7/19 added im_width, im_height
